package com.example.lab_week_08_sandy.service
...
import com.example.lab_week_08_sandy.MainActivity
import com.example.lab_week_08_sandy.R
...
class SecondNotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        val handleThread = HandlerThread("Third Thread")
            .apply { start() }
    ...
    private fun getNotificationBuilder(pendingIntent: PendingIntent, channelId: String) =
        NotificationCompat.Builder(this, channelId)
            ...
            .setContentText("Leaking your data...")
