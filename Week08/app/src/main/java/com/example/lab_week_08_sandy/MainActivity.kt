...
import com.example.lab_week_08_sandy.service.SecondNotificationService
import com.example.lab_week_08_sandy.worker.FirstWorker
import com.example.lab_week_08_sandy.worker.SecondWorker
import com.example.lab_week_08_sandy.worker.ThirdWorker
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NotificationService.trackingCompletion.observe(this) { channelId ->
            showResult("NotificationService done: $channelId")
            workManager.beginWith(thirdRequest)
                .enqueue()
        }
